...
if __name__ == '__main__':
    ...
    parser.add_argument('-weights_path', type=str, default="checkpoints/mobilenet-best.pth", help='path to model weights')
    parser.add_argument('-batch_size', type=int, default=128, help='batch size for evaluation')
    parser.add_argument('-gpu', action='store_true', default=True, help='use GPU for evaluation')
